...
Клад расположен в указанном месте, ПРИКОП ровно по стрелкам на фотографии📸
...
С КАЙФОМ ВАС ЖДУТ легкие НАХОДЫ и ОТЛИЧНОЕ НАСТРОЕНИЕ! Витрина пополняется каждый день! ВСЕ БУДЕТ КАЙФ - И ТОЧКА.💯""",
            "images": [
                "https://s.fiho-st.sbs/i/2025/11/98cb3/6b950178d9ce8b3f55e9f9f0c4d741c0-img_5055.jpg"
            ]
        },
        "1.5г": {
            "text": """«КАЙФ - И ТОЧКА»™️
